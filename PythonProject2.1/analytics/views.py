...
from .forms import ResultsUploadForm, TeacherUserLinkForm, NewsForm
from .models import (
    AuditLog,
    Discipline,
    Group,
...
def info(request, slug):
    templates = {
        "about": "analytics/info/about.html",
        "applicant": "analytics/info/applicant.html",
        "student": "analytics/info/student.html",
        "distance": "analytics/info/distance.html",
    }
